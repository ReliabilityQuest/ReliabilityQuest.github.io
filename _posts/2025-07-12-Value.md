...
Understand the customer's reliability over the past few years. This reliability is defined traditionally as a ratio of Unplanned Outage Hours (UOH) to the number of hours in a year.

$$
\text{Reliability} = 1 - \frac{\text{UOH}}{8760}
$$

Since APM is reducing some of the unplanned downtime, it will, by definition, increase reliability. A reasonable and conservative estimate of the amount of reliability to improve is 20%.

Applying this benefit on an annual basis would be:

$$
\text{Benefit} = 0.2 \times \frac{\text{UOH}}{8760}
$$
...
I also like to take the company's EBITDA margin (or whatever margin they typically refer to in their annual report) and translate that revenue into something closer to earnings or profit. It's a more accurate estimate of customer value than revenue itself.
