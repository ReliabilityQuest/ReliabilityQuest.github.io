...
- ### How to estimate the value
  ...
  Understand the customer's reliability over the past few years. This reliability is defined traditionally as a ratio of Unplanned Outage Hours (UOH[^Taken from [NERC's definition](https://www.nerc.com/comm/PC/Generating%20Availability%20Data%20System%20Working%20Gro1/Item%203b_%20Appendix_F%20-%20Equations%20Rev1.pdf): Sum of all hours experienced during Forced Outages (U1, U2, U3) + Startup Failures (SF) + Maintenance Outages (MO) + Maintenance Outage Extensions (ME) of any Maintenance Outages (MO).
  ]) to the number of hours in a year.
  
  $$
  Reliability = 1 - \frac{UOH}{8,760}
  $$
  
  Since APM is reducing some of the unplanned downtime, it will, by definition, increase reliability. A reasonable an conservative estimate of the amount of reliability to improve is 20%[^If you'd like an explanation where this 20% came from, email or call me.]. 
...
- ### How to estimate the value
  ...
  By reviewing a customer's annual reports or investor presentations, you sometimes can infer what their annual maintenance cost is. If the customer is open, try asking them. I have found the customer to be much more open if I come in with an estimated number first. For example, I estimated that an air separation company in the US had a total maintenance budget of around $350M. When I presented that in the spreadsheet, one of the reliability directors corrected me and said they were closer to $325M. My point is not to illustrate that I got close, but to note that if we put in the effort to try and understand their business and how we are going to help them, they are more willing to collaborate.
